...
//            shoesService.orderItemCreated(ShoesId.of(event.getProductId()), event.getQuantity());
//        } catch (Exception e){
//
//        }
//
...
//            shoesService.orderItemRemoved(ShoesId.of(event.getProductId()), event.getQuantity());
//        } catch (Exception e){
//
//        }
//
